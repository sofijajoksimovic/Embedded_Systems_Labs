...
void LCD_StrelicaGore(){
	LCD_CommandEnqueue(LCD_INSTRUCTION, LCD_SET_CG_RAM_ADDRESS_INSTRUCTION | 0x10);
	LCD_CommandEnqueue(LCD_DATA, 0x04); //_ _ X _ _
	LCD_CommandEnqueue(LCD_DATA, 0x0E); //_ X X X _
	LCD_CommandEnqueue(LCD_DATA, 0x15); //X _ X _ X
	LCD_CommandEnqueue(LCD_DATA, 0x04); //_ _ X _ _
	LCD_CommandEnqueue(LCD_DATA, 0x04); //_ _ X _ _
	LCD_CommandEnqueue(LCD_DATA, 0x04); //_ _ X _ _
	LCD_CommandEnqueue(LCD_DATA, 0x04); //_ _ X _ _
